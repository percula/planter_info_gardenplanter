...
See [Getting Started]({% link getting-started %}) for information on gardens, plants, and more. This FAQ only contains information not already included in that section.
